    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(default=None, help_text='Client Placing the order', limit_choices_to={'is_active': True, 'is_staff': False}, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, to_field='username', verbose_name='user')),
                ('writer', models.ForeignKey(help_text='Who is assigned to work on this order', limit_choices_to={'is_active': True}, on_delete=django.db.models.deletion.PROTECT, to='order.Writer', to_field='username', verbose_name='writer')),
            ],
            options={
                'verbose_name': 'Order',
