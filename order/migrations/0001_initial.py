    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(blank=True, help_text='Writer first name.', max_length=30, verbose_name='first name')),
                ('last_name', models.CharField(blank=True, help_text='Writer last name.', max_length=150, verbose_name='last name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deletedAt', models.DateTimeField(blank=True, null=True, verbose_name='deletedAt')),
                ('updateAt', models.DateTimeField(auto_now=True, verbose_name='updateAt')),
                ('card', models.CharField(default='not card', help_text='Order unique number', max_length=10, unique=True)),
                ...
                ('academic', models.CharField(choices=[(None, 'Unknown'), ('HIGHSCHOOL', 'HIGHSCHOOL'), ('PHD', 'PHD'), ('GRADUATE', 'GRADUATE'), ('UNDERGRADUATE_1_2', 'UNDERGRADUATE_1_2'), ('UNDERGRADUATE_3_4', 'UNDERGRADUATE_3_4')], default='HIGHSCHOOL', help_text='Clients academic level', max_length=200, verbose_name='academic')),
                ('format', models.CharField(choices=[(None, 'Unknown'), ('MLA', 'MLA'), ('CHICAGO/TURABIAN', 'CHICAGO/TURABIAN'), ('APA7', 'APA7'), ('APA6', 'APA6')], default='MLA', help_text='Format chosen by client for this order, eg. MLA, APA6...', max_length=30)),
                ('spacing', models.CharField(choices=[(None, 'Unknown'), ('SINGLE', 'SINGLE'), ('DOUBLE', 'DOUBLE')], default='SINGLE', help_text='Whether order is single or double spaced', max_length=10)),
                ...
                ('status', models.CharField(choices=[(None, 'Unknown'), ('DRAFT', 'DRAFT'), ('REVISION', 'REVISION'), ('ACTIVE', 'ACTIVE'), ('FINISHED', 'FINISHED'), ('CANCELED', 'CANCELED'), ('DISPUTE', 'DISPUTE')], default='ACTIVE', help_text='Where an order belongs to ether active, deleted, or ..', max_length=10)),
                ...
                ('smart', models.BooleanField(default=False, help_text='Whether an order is  a smart paper.', verbose_name='is_paper')),
                ...
                ('user', models.ForeignKey(default=0, help_text='Client Placing the order', limit_choices_to={'is_active': True, 'is_staff': False}, on_delete=django.db.models.deletion.SET_DEFAULT, to=settings.AUTH_USER_MODEL, verbose_name='user')),
                ('writer', models.ForeignKey(default=0, help_text='Who is assigned to work on this order', limit_choices_to={'is_active': True}, on_delete=django.db.models.deletion.SET_DEFAULT, to='order.Writer', verbose_name='writer')),
            ],
            options={
                'verbose_name': 'Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deletedAt', models.DateTimeField(blank=True, null=True, verbose_name='deletedAt')),
                ('updateAt', models.DateTimeField(auto_now=True, verbose_name='updateAt')),
                ('content', models.TextField(help_text='Notification message', max_length=1000)),
                ...
                ('created', models.ForeignKey(default='deleted', help_text='Which admin created', limit_choices_to={'is_active': True, 'user_type': ['MASTER', 'ADMIN']}, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='created', related_query_name='creator', to=settings.AUTH_USER_MODEL, to_field='username')),
                ('user', models.ForeignKey(default='deleted', help_text='User to be sent this notification', limit_choices_to={'is_active': True, 'user_type': 'USER'}, on_delete=django.db.models.deletion.SET_DEFAULT, to=settings.AUTH_USER_MODEL, to_field='username')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deletedAt', models.DateTimeField(blank=True, null=True, verbose_name='deletedAt')),
                ('updateAt', models.DateTimeField(auto_now=True, verbose_name='updateAt')),
                ('description', models.CharField(blank=True, help_text='Client description of what this files contains', max_length=200, null=True)),
                ...
                ('order', models.ForeignKey(default='deleted', help_text='Link to the order', limit_choices_to={'is_paper': True}, on_delete=django.db.models.deletion.SET_DEFAULT, to='order.Order', to_field='card')),
            ],
            options={
                'verbose_name': 'File',
