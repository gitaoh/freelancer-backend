# Generated by Django 3.0.7 on 2020-08-14 13:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic', models.CharField(choices=[('HIGHSCHOOL', 'HIGHSCHOOL'), ('PHD', 'PHD'), ('GRADUATE', 'GRADUATE'), ('UNDERGRADUATE_1_2', 'UNDERGRADUATE_1_2'), ('UNDERGRADUATE_3_4', 'UNDERGRADUATE_3_4')], default='HIGHSCHOOL', max_length=200, verbose_name='academic')),
                ('title', models.CharField(max_length=200, verbose_name='title')),
                ('instructions', models.TextField()),
                ('format', models.CharField(choices=[('MLA', 'MLA'), ('CHICAGO/TURABIAN', 'CHICAGO/TURABIAN'), ('APA7', 'APA7'), ('APA6', 'APA6')], default='MLA', max_length=30)),
                ...
                ('status', models.CharField(choices=[('DRAFT', 'DRAFT'), ('REVISION', 'REVISION'), ('ACTIVE', 'ACTIVE'), ('FINISHED', 'FINISHED'), ('CANCELED', 'CANCELED'), ('DISPUTE', 'DISPUTE')], default='ACTIVE', max_length=10)),
