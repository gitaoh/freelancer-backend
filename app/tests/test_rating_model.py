...
class RatingModelTestcase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.default = 5
        cls.model = Rating
        cls.model_data = mixer.blend(cls.model, rate=cls.default)
    ...
    def test_meta_class_for_the_model(self):
        ...
        self.assertEqual(meta.db_table, 'Ratings')
    ...
    def test_the_rate_column(self):
        ...
        self.assertEqual(len(rate.validators), 1)
    ...
    def test_the_client_column(self):
        ...
        print(client.to)
        # self.assertEqual(client.to, 'settings.AUTH_USER_MODEL')
        self.assertEqual(client.to_field, 'username')
        print(client.default)
        # self.assertEqual(client.default, 'deleted')
