    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_avatar', models.BooleanField(default=True, help_text='If an avatar is deleted')),
            ],
            options={
                'verbose_name': 'Avatar',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deletedAt', models.DateTimeField(null=True, verbose_name='deletedAt')),
                ('updatedAt', models.DateTimeField(auto_now=True, verbose_name='updatedAt')),
                ('rate', models.PositiveIntegerField(validators=[django.core.validators.MaxValueValidator(limit_value=10)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('native', models.BooleanField(default=False, help_text='Client Only wants native English writers to work on their order')),
